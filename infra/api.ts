...
export const apiFunction = new sst.aws.Function('MyApiFunction', {
	...
	url: {
		cors: {
			...
			allowOrigins:
				$app.stage === 'prod' ? ['https://iot.iamlim.com'] : ['https://dev.iot.iamlim.com'],
			exposeHeaders: exposeHeaders,
...
//     zone: $app.stage === "prod" ? "Z0140882217FY9MCT4KM1" : "Z1048110TMWW9X3WITD5",
//   }),
//     name: $app.stage === "prod" ? "ws.iamlim.com" : "ws.dev.iamlim.com",
// },
//   accessLog: { retention: "1 day"  },
// });
// ws.route("$connect", "./packages/core/src/ws.handler");
// ws.route("$disconnect", "./packages/core/src/ws.handler");
// ws.route("$default", "./packages/core/src/ws.handler");
// ws.route("sendMessage", "./packages/core/src/ws.handler");
